...
> **Migration status：`REVIEW_NEEDED`。** 本文保留旧测试体系的设计与证据边界；
> MIG-2/MIG-3 尚未把对应 Langfuse、pytest 和 CI 资产迁入 latest upstream，MIG-4 也尚未复验。
> 当前状态以 [`testing/MIGRATION_STATUS.md`](testing/MIGRATION_STATUS.md) 为准。
